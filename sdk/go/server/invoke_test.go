...
// 129 → 132（2026-09-12，leaderboards.proto 新增排行榜 server 面——wrapper：
// LeaderboardsService.SubmitLeaderboardScore / GetLeaderboardEntry /
// ListLeaderboardTop）；
// 132 → 134（2026-09-12，leaderboards.proto Phase 2 结算读——wrapper：
// LeaderboardsService.GetLeaderboardSettlement / ListLeaderboardSettlements）。

// 134 → 141（2026-09-12，analytics.proto 新增事件分析面七方法（合并自 feat/analytics，
...
// 146 → 149（2026-09-14，runbook.proto 新增迁移状态面三方法（docs/design/
// runbook.md §2.2 阶段 A），wrapper：RunbookService.GetRunbookState /
// RecordRunbookStep / DeleteRunbookStep）。

const expectedServerMethodCount = 149
