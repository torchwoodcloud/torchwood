...
// Service 是 packer 的 lynx 服务装配：单 HTTP API 面（独立二进制
// cmd/packer；不进 server/worker wire）。无 Redis/DB/docker 依赖
...
func (s *Service) Name() string { return "packer" }
...
func (s *Service) Start(ctx context.Context) error {
	...
	s.logger.Info("packer started", "addr", s.http.Addr,
