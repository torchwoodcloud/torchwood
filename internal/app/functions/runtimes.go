...
// main）；go-1.26 → golang:1.26-alpine 多阶段构建，zip 根 = 用户持有
// package main（SDK github.com/torchwoodcloud/torchwood/sdk/go/functions
// 或自写 HTTP 服务实现 :18080 公开契约），构建 = `go build .` 平台零注入
// （五期 5b，设计 docs/design/functions-runtimes-and-sources.md 顶部立项段；
// 基础镜像 tag 与 runtime ID 同步定稿，升级 = 新 runtime ID、旧 ID 不
