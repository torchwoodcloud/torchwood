...
func newFileHandlerTestAccount(cfg *config.AppConfig, projectRepo projects.Repository, db *clients.Database) *client.Account {
	...
	return client.NewAccount(cfg, projectRepo, nil, nil, sessions, nil, nil, nil, nil, nil, nil, nil, nil, nil, roles, nil, nil, nil, nil, usersRepo, identities, sessionRepo, auth.NewOAuthAuthenticatorFactory(), auth.NewWeChatMiniProgramExchanger(), auth.NewOTPGenerator(), nil, nil, nil, nil)
}
