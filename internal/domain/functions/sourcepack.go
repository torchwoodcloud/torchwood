...
const (
	...
	// DeploymentSourceGit 是 git 仓库源（二期）：由独立 packer
	// 服务物化为 zip 落既有构建路径。
...
// packer 服务物化为 zip 落既有 zipPath。Username/Token 是一次性
