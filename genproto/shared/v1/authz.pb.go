...
const (
	...
	ScopeResource_SCOPE_RESOURCE_ANALYTICS       ScopeResource = 15
	ScopeResource_SCOPE_RESOURCE_RUNBOOKS        ScopeResource = 16
	ScopeResource_SCOPE_RESOURCE_RUNTIME_VARS    ScopeResource = 17
)
...
var (
	ScopeResource_name = map[int32]string{
		...
		15: "SCOPE_RESOURCE_ANALYTICS",
		16: "SCOPE_RESOURCE_RUNBOOKS",
		17: "SCOPE_RESOURCE_RUNTIME_VARS",
	}
	ScopeResource_value = map[string]int32{
		...
		"SCOPE_RESOURCE_ANALYTICS":       15,
		"SCOPE_RESOURCE_RUNBOOKS":        16,
		"SCOPE_RESOURCE_RUNTIME_VARS":    17,
	}
)
...
const file_shared_v1_authz_proto_rawDesc = "" +
	...
	"\x10ADMIN_ROLE_OWNER\x10\x04*\xaa\x04\n" +
	...
	"\x18SCOPE_RESOURCE_ANALYTICS\x10\x0f\x12\x1b\n" +
	"\x17SCOPE_RESOURCE_RUNBOOKS\x10\x10\x12\x1f\n" +
	"\x1bSCOPE_RESOURCE_RUNTIME_VARS\x10\x11*^\n" +
	"\aScopeOp\x12\x18\n" +
