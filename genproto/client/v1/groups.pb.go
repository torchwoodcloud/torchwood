...
const file_client_v1_groups_proto_rawDesc = "" +
	...
	"\x10DeleteMembership\x12).torchwood.client.v1.GetMembershipRequest\x1a\x1a.torchwood.shared.v1.Empty\"9\x82\xd3\xe4\x93\x023*1/v1/groups/{group_id}/memberships/{membership_id}\x1a\x06\x92\xb2\x19\x02\b\x02B\xf7\x03\x92A\xb2\x03RR\n" +
	"\adefault\x12G\n" +
