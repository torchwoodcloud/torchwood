...
const file_server_v1_payments_proto_rawDesc = "" +
	...
	"\x1a\x02\x03\x04\"\x04\b\b\x10\x02\x82\xd3\xe4\x93\x022:\x01*\"-/v1/server/payments/orders/{order_id}:fulfill\x1a\x06\x92\xb2\x19\x02\b\x03B\xdb\x03\x92A\x96\x03RR\n" +
	"\adefault\x12G\n" +
