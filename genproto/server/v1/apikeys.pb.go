...
func (x *WhoAmIResponse) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *WhoAmIResponse) GetMaxAgeSeconds() int64 {
	if x != nil {
...
const file_server_v1_apikeys_proto_rawDesc = "" +
	...
	"\rWhoAmIRequest\"\x9a\x01\n" +
	"\x0eWhoAmIResponse\x12\x15\n" +
