...
func wireBootstrap(app lynx.App) (*boot.Bootstrap, func(), error) {
	...
	functionsFunctions := functions2.NewFunctionsWithSourcePacker(appConfig, dispatcherExecutor, functionRepo, sharedQueue, redisCounter, repository, semaphores, redisExecutionTokenService, triggerRepo, clientQuotaLimiter, packerClient)
